...
class InitializationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InitializationRequest', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restorationKey', protoName: 'restorationKey')
    ..hasRequiredFields = false
  ;

  InitializationRequest._() : super();
  factory InitializationRequest({
    $core.String? restorationKey,
  }) {
    final _result = create();
    if (restorationKey != null) {
      _result.restorationKey = restorationKey;
    }
    return _result;
  }
  factory InitializationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InitializationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  InitializationRequest clone() => InitializationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InitializationRequest copyWith(void Function(InitializationRequest) updates) => super.copyWith((message) => updates(message as InitializationRequest)) as InitializationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InitializationRequest create() => InitializationRequest._();
  InitializationRequest createEmptyInstance() => create();
  static $pb.PbList<InitializationRequest> createRepeated() => $pb.PbList<InitializationRequest>();
  @$core.pragma('dart2js:noInline')
  static InitializationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InitializationRequest>(create);
  static InitializationRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get restorationKey => $_getSZ(0);
  @$pb.TagNumber(1)
  set restorationKey($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasRestorationKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearRestorationKey() => clearField(1);
}
...
class DeviceInfoCollection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceInfoCollection', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceInfoCollection copyWith(void Function(DeviceInfoCollection) updates) => super.copyWith((message) => updates(message as DeviceInfoCollection)) as DeviceInfoCollection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
