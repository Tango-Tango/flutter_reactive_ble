...
class InitializationRequest extends $pb.GeneratedMessage {
  factory InitializationRequest({
    ...
    if (restorationKey != null) {
      $result.restorationKey = restorationKey;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InitializationRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'restorationKey', protoName: 'restorationKey')
  ...
  'Will be removed in next major version')
  InitializationRequest copyWith(void Function(InitializationRequest) updates) => super.copyWith((message) => updates(message as InitializationRequest)) as InitializationRequest;
