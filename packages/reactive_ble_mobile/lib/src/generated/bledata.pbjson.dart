...
const InitializationRequest$json = {
  '1': 'InitializationRequest',
  '2': [
    {'1': 'restorationKey', '3': 1, '4': 1, '5': 9, '10': 'restorationKey'},
  ],
};

/// Descriptor for `InitializationRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List initializationRequestDescriptor = $convert.base64Decode(
    'ChVJbml0aWFsaXphdGlvblJlcXVlc3QSJgoOcmVzdG9yYXRpb25LZXkYASABKAlSDnJlc3Rvcm'
    'F0aW9uS2V5');
